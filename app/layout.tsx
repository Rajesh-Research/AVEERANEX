...
export default function RootLayout({ children }: { children: React.ReactNode }) { return <html lang="en"><body><a className="skip-link" href="#main">Skip to content</a><Header />{children}<Footer /><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ '@context': 'https://schema.org', '@type': 'Organization', name: 'AVEERANEX (OPC) PRIVATE LIMITED', legalName: 'AVEERANEX (OPC) PRIVATE LIMITED', url: 'https://aveeranex.com', logo: 'https://aveeranex.com/icon.svg', description: 'AVEERANEX is a technology company developing intelligent digital products and platforms across education, AI, and knowledge intelligence.', email: 'info@aveeranex.com', contactPoint: { '@type': 'ContactPoint', email: 'info@aveeranex.com', contactType: 'customer service' }, address: { '@type': 'PostalAddress', addressCountry: 'IN' } }) }} /></body></html>; }
